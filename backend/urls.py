...
from tennis_app.views import SignupView, PlayerRankingView, UploadImagesView, UploadVideoView
...
router.register('uploadedvideos', UploadVideoView, 'uploadedvideos')
